function [w]=twobodiesoscillations_sol     
%computing normal modes for different values of masses and spring constants

% system is composed of   wall1 - spring1 - mass1 - spring2 - mass2 - spring3 - wall2 
...
w=sqrt(-diag(D)); %converts the eigevalues to eigenfrequencies         

figure; plot([1,2],V(:,1),'o--',[1,2],V(:,2),'o--'); 
xlim([0.5,2.5]); ylim([-1,1]);   

% dynamics
% first we prepare a matrix param where we write our parameters    
param=M\K;
